    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="user_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Harsh Devansh Harsh Vardhan, Inc." data-placement="bottom" target="">
                    E commerce website
                </a>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <h2 class="title">Showing Results of products</h2>
        ...
        <footer class="footer" data-background-color="black">
            <div class="container">
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Harsh  Devansh Harsh Vardhan,inc
                </div>
            </div>
        </footer>
    </div>
